const platform = 'django'  // vue、django、cloud 3种开发模式
...
if (platform === 'vue') {
    ...
    CONFIG_API.HTTP_URL = 'https://app1565.acapp.acwing.com.cn'
    CONFIG_API.VAD_URL = 'https://app1565.acapp.acwing.com.cn/static/frontend/vad/'
}
